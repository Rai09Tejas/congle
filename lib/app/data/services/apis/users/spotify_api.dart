...
// !: https://developer.spotify.com/documentation/web-api/reference/#category-personalization
  ...
  final String redirectUrl = 'app://congle/auth';
  ...
  final String topArtistsBaseUrl = 'https://api.spotify.com/v1/me/top/artists';
  final String topTracksBaseUrl = 'https://api.spotify.com/v1/me/top/tracks';
  ...
  Future<List> getUserTopTracks(String accessToken) async {
    try {
      final Uri path = Uri.parse('$topTracksBaseUrl?limit=3');
      ...
      if (response.statusCode == 200) {
        ...
        playlists.map((e) {
          return {
            ...
            "id": e['id'],
            "image": e["image"],
            "artists": e['artists'], // e.map((e)=> e['name']).toList()
            "name": e['name'],
            "uri": e['uri']
          };
        }).toList();
  ...
  Future<List> getUserTopArtists(String accessToken) async {
    try {
      final Uri path = Uri.parse('$topArtistsBaseUrl?limit=5');
      ...
      if (response.statusCode == 200) {
        ...
        playlists.map((e) {
          return {
            'href': e["href"],
            "id": e['id'],
            "images": e['images'], // e.map((e)=> e['url']).toList()
            "name": e['name'],
            "uri": e['uri']
          };
        }).toList();
