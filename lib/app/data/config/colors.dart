...
const Color kcLightGrey = Color(0xffC7C7C7);

/// ![#ededed](https://via.placeholder.com/15/ededed/000000?text=+) `#ededed`
const Color kcLameGrey = Color(0xffededed);
...
/// ![#c8de44](https://via.placeholder.com/15/c8de44/000000?text=+) `#c8de44`
const Color kcGreen = Color(0xFFC8DE44);

/// ![#fff2f0e4](https://via.placeholder.com/15/c8de44/000000?text=+) `#fff2f0e4`
const Color kcOffwhiteBg = Color(0xFFF2F0E4);


LinearGradient kcgButton = LinearGradient(
  begin: const Alignment(-1.67, -0.36),
  end: const Alignment(1.92, 0.38),
