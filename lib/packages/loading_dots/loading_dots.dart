...
class _DotLoading extends StatelessWidget {
  final Color color;
  const _DotLoading({Key? key, required this.color}) : super(key: key);
...
class LoadingDots extends StatefulWidget {
  ...
  /// has 3 dots and white color
  const LoadingDots(
      {Key? key, this.numberOfDots = 3, this.color = Colors.white60})
      : super(key: key);

  /// has 5 dots and app accent color
  const LoadingDots.long(
      {Key? key, this.numberOfDots = 5, this.color = kcAccent})
      : super(key: key);
